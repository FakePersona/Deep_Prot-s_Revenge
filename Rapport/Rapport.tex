...
finale du réseau de neurone: un score est calculé sur l'objectif final, et il
s'agit alors de minimiser la distance par rapport au score attendu. Pour ce
faire, on peut par exemple procéder par descente de gradient. En effet, pour
chaque paramètre, on calcul la dérivée partielle du score obtenu et on ajuste en
...
intermédiaires et sur ce qu'elles nous apprennent sur les fragments de séquences
peptidiques ayant servi à l'entraînement de l'auto-encodeur.
