...
#Recurrent encoder
dum1 = Convolution1D(10, 3, activation='relu', input_shape=(11, ACIDS))
dum.add(dum1)
dum.add(Dropout(0.2))

dum2 = Convolution1D(10, 2, activation='relu')
dum.add(dum2)
dum.add(Dropout(0.1))

dum3 = Convolution1D(13, 2, activation='relu')
dum.add(dum3)
dum.add(Dropout(0.1))

dum4 = Convolution1D(3, 2, activation='relu')
dum.add(dum4)
dum.add(Dropout(0.1))

dum5 = Convolution1D(6, 2, activation='relu')
dum.add(dum5)
dum.add(Dropout(0.2))

dum.add(Flatten())

dum6 = Dense(encoding_dim)
dum.add(dum6)
...
dum.load_weights("ConvOne.h5")

print("Creating actual model")

model = Sequential()

model.add(TimeDistributed(dum1, input_shape = (140, 11, 26)))
...
model.add(TimeDistributed(dum4))
model.add(TimeDistributed(Dropout(0.1)))

model.add(TimeDistributed(dum5))
model.add(TimeDistributed(Dropout(0.2)))

model.add(TimeDistributed(Flatten()))

model.add(TimeDistributed(dum6))
